            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-md-block">
                        <h3>Sebentar lagi UAS harap potong rambut.</h3>
                        <p>
                            tidak bisa UAS jika tidak potong
                            <br>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="about_content" style="text-align: center;">
                    <h3>Introducing</h3>
                    <h2>The Barber Shop <br>Science 2024</h2>
                    <img src="Design/images/about-logo.png" alt="logo">
                    <p style="color: #777">
                        wes pokok panggon potong
                    </p>
...
<section class="services_section" id="services">
    <div class="container">
        ...
        <div class="row" style="display: flex; justify-content: center; flex-wrap: wrap;">
            <div class="col-lg-3 col-md-6 padd_col_res" style="display: flex; justify-content: center; align-items: center; padding: 15px;">
            ...
            <div class="col-md-6 offset-md-6">
                <form action="appointment.php" method="post" id="appointment_form" class="form-horizontal appointment_form">
                    <div class="book_content">
                        <h2 style="color: white;">BOOKING SEK BOLO</h2>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 gallery-column">
                <div style="height: 350px">
                    <div class="gallery-img" style="background-image: url('Design/images/portfolio-9.jpg');"></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <ul class="team_members row">
            <li class="col-lg-3 col-md-6 padd_col_res">
                <div class="team_member">
                    <img src="Design/images/portfolio-9.jpg" alt="Team Member">
                </div>
            </li>
...
<section class="pricing_section" id="pricing">
    ...
    <div class="container">
        <div class="section_heading">
            <h3>Ada harga ada kualitas. kelarangen ?? </h3>
            <h2>gak usah potong</h2>
            <div class="heading-line"></div>
        </div>
        <div class="row">
            <?php
